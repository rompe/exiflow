...
class Directorychooser1(object):
    ...
    def __init__(self, parent=None, callback=None):
        ...
        self.builder.add_objects_from_file(gladefile, ("directorychooserdialog1",))
...
class Filechooser1(object):
    ...
    def __init__(self, parent=None, callback=None):
        """ Instantiate the chooser. """
        self.builder = Gtk.Builder()
        self.builder.add_objects_from_file(gladefile, ("filechooserdialog1",))
...
class Window1(object):
    ...
    def __init__(self):
        ...
        self.builder = Gtk.Builder()
        self.builder.add_objects_from_file(gladefile, ("mainwindow",))
        ...
        self.builder.connect_signals(dic)
        self.window.show()
        self.window.show_all()  # Create TextView and use it
        sys.stdout = WritableTextView(self.builder.get_object("textview1"))
        sys.stderr = WritableTextView(self.builder.get_object("textview1"),
                                      "blue")
        stdlog = WritableTextView(self.builder.get_object("textview1"), "red")
    ...
    def set_active(self, name):
        ...
        self.builder.get_object(name).set_active(1)

    def set_text(self, name, text):
        """ Set text of widget "name" to text. """
        self.builder.get_object(name).set_text(text)
    ...
    def on_info1_activate(*dummy):
        ...
        builder = Gtk.Builder()
        builder.add_objects_from_file(gladefile, ("aboutdialog1",))
